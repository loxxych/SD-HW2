...
- Добавление операции: Добавить новую операцию, выбрав категорию, счет, вводя сумму и описание (по желанию). !!Чтобы добавить операцию, ДОЛЖЕН ИМЕТЬСЯ ХОТЯ БЫ 1 СЧЕТ и 1 КАТЕГОРИЯ!!     
